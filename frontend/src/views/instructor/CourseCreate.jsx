...
//     }
//     console.log("cat", course.category, formdata, course.file);
...
function CourseCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("cattt--", course.category);
    ...
    try {
      const response = await axiosInstance.post(`teacher/course-create/`, formdata, {
        headers: {
...
//       Swal.fire({
//         icon: "error",
//         title: "You need to log in to create a course",
//       });
//       history.push("/login");
//       return;
//     }
...
//     formdata.append("slug", course.slug);
//     formdata.append("date", course.date);
//     formdata.append("teacher", parseInt(user?.teacher_id));
